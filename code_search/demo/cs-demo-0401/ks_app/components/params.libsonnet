{
  ...
  components: {
    ...
    "iap-ingress": {
      ...
      hostname: 'cs-demo-0401.endpoints.code-search-demo.cloud.goog',
      ingressSetupImage: 'gcr.io/kubeflow-images-public/ingress-setup:latest',
      ipName: 'cs-demo-0401-ip',
    ...
    pipeline: {
      minioPd: 'cs-demo-0401-storage-artifact-store',
      mysqlPd: 'cs-demo-0401-storage-metadata-store',
      name: 'pipeline',
    },
    "pytorch-operator": {
      cloud: 'null',
    ...
    spartakus: {
      name: 'spartakus',
      reportUsage: true,
      usageId: '4.5190607272040325e+18',
    },
    tensorboard: {
